...
__turbopack_context__.s({
    ...
    "getBrazilianHolidays": (()=>getBrazilianHolidays),
...
function getSLATimeRemaining(deadlineString) {
    const now = new Date();
    ...
    if (diffInHours < 1) {
        ...
        return {
            ...
            status: 'critical',
            percentage: Math.max(0, diffInHours / 24 * 100)
        };
    }
    if (diffInHours < 4) {
        return {
            text: `${Math.floor(diffInHours)}h restantes`,
            status: 'critical',
            percentage: Math.max(0, diffInHours / 24 * 100)
        };
    }
    if (diffInHours < 12) {
        return {
            text: `${Math.floor(diffInHours)}h restantes`,
            status: 'warning',
            percentage: diffInHours / 24 * 100
        };
    }
    const days = Math.floor(diffInHours / 24);
    const hours = Math.floor(diffInHours % 24);
    return {
        text: days > 0 ? `${days}d ${hours}h restantes` : `${hours}h restantes`,
        status: 'ok',
        percentage: Math.min(100, diffInHours / 72 * 100) // Assumindo SLA padrão de 72h
    };
}
...
function generateTicketId(prefix = 'SD') {
    const year = new Date().getFullYear();
    const timestamp = Date.now().toString().slice(-6);
    const random = Math.floor(Math.random() * 1000).toString().padStart(3, '0');
    return `${prefix}-${year}-${timestamp}${random}`;
}
function calculatePriority(category, createdAt) {
    const now = new Date();
    const created = new Date(createdAt);
    const hoursElapsed = (now.getTime() - created.getTime()) / (1000 * 60 * 60);
    // Regras específicas por categoria
    switch(category){
        case 'Peças Betim/Goiana/Porto Real':
            if (hoursElapsed > 20) return 'Urgente';
            if (hoursElapsed > 12) return 'Alta';
            return 'Média';
        case 'Garantia Brasil':
            if (hoursElapsed > 60) return 'Alta';
            if (hoursElapsed > 24) return 'Média';
            return 'Baixa';
        case 'Suporte Técnico':
            if (hoursElapsed > 40) return 'Alta';
            if (hoursElapsed > 20) return 'Média';
            return 'Baixa';
        default:
            if (hoursElapsed > 96) return 'Média';
            return 'Baixa';
    }
}
function isBusinessHours(date = new Date()) {
    ...
    const day = brazilTime.getDay() // 0 = domingo, 6 = sábado
    ;
    const hour = brazilTime.getHours();
    // Segunda a sexta, 8h às 18h
    return day >= 1 && day <= 5 && hour >= 8 && hour < 18;
}
function getBrazilianHolidays(year = new Date().getFullYear()) {
    const holidays = [
        new Date(year, 0, 1),
        new Date(year, 3, 21),
        new Date(year, 4, 1),
    ...
    // Adicionar feriados móveis (Carnaval, Sexta-feira Santa) seria mais complexo
    // e requereria cálculo baseado na Páscoa
    return holidays;
}
function isBrazilianHoliday(date) {
    const holidays = getBrazilianHolidays(date.getFullYear());
    return holidays.some((holiday)=>holiday.getDate() === date.getDate() && holiday.getMonth() === date.getMonth());
}
...
"[project]/src/app/service-desk/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>ServiceDeskDashboard)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
...
const mockTickets = [
    {
        id: 'SD-2024-001',
        title: 'Peça indisponível - Filtro de óleo Peugeot 208',
        category: 'Peças Betim/Goiana/Porto Real',
        priority: 'Alta',
        status: 'Em Andamento',
        createdAt: '2024-01-15T09:30:00Z',
        slaDeadline: '2024-01-15T13:30:00Z',
        dealership: 'Peugeot São Paulo Centro',
        brand: 'Peugeot'
    },
    {
        id: 'SD-2024-002',
        title: 'Solicitação de garantia - Motor Fiat Argo',
        category: 'Garantia Brasil',
        priority: 'Média',
        status: 'Aberto',
        createdAt: '2024-01-15T10:15:00Z',
        slaDeadline: '2024-01-15T14:15:00Z',
        dealership: 'Fiat Belo Horizonte',
        brand: 'Fiat'
    },
    {
        id: 'SD-2024-003',
        title: 'Dúvida técnica - Sistema de injeção C4 Cactus',
        category: 'Suporte Técnico',
        priority: 'Média',
        status: 'Resolvido',
        createdAt: '2024-01-14T16:45:00Z',
        slaDeadline: '2024-01-16T16:45:00Z',
        dealership: 'Citroën Rio de Janeiro',
        brand: 'Citroën'
    }
];
const categories = [
    'Peças Betim/Goiana/Porto Real',
    'Garantia Brasil',
    'Suporte Técnico',
    'Campanhas & Incentivos',
    'Marketing Co-Op'
];
function ServiceDeskDashboard() {
    ...
    const [tickets, setTickets] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(mockTickets);
    ...
    const filteredTickets = selectedCategory === 'todos' ? tickets : tickets.filter((ticket)=>ticket.category === selectedCategory);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                ...
                                children: "Dashboard Service Desk"
                            }, void 0, false, {
                                fileName: "[project]/src/app/service-desk/page.tsx",
                                lineNumber: 137,
                                columnNumber: 11
                            }, this),
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-gray-600 mt-1",
                                children: "Gestão unificada de atendimento - Rede Nacional"
                            }, void 0, false, {
                                fileName: "[project]/src/app/service-desk/page.tsx",
                                lineNumber: 138,
                                columnNumber: 11
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: stats.total.toLocaleString('pt-BR')
                                }, void 0, false, {
                                    fileName: "[project]/src/app/service-desk/page.tsx",
                                    lineNumber: 159,
                                    columnNumber: 13
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                                            children: selectedCategory === 'todos' ? 'Todos os Tickets' : selectedCategory
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/service-desk/page.tsx",
                                            lineNumber: 222,
                                            columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        className: "space-y-4",
                                        children: filteredTickets.map((ticket)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                                                                className: getBrandColor(ticket.brand),
                                                                                children: ticket.brand
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/src/app/service-desk/page.tsx",
                                                                                lineNumber: 242,
                                                                                columnNumber: 29
...
_s(ServiceDeskDashboard, "FI5Gx1qlwhH0yyfDrprhrtUnGL4=");
_c = ServiceDeskDashboard;
var _c;
__turbopack_context__.k.register(_c, "ServiceDeskDashboard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_6c528106._.js.map